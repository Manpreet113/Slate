...
Singleton {
    ...
    property string configDir: (Quickshell.env("XDG_CONFIG_HOME") || (Quickshell.env("HOME") + "/.config")) + "/slate/config"
    property string keybindsPath: (Quickshell.env("XDG_CONFIG_HOME") || (Quickshell.env("HOME") + "/.config")) + "/slate/binds.json"
    ...
    FileView {
        ...
        adapter: JsonAdapter {
            ...
            property string customText: "Elysium"
        ...
        adapter: JsonAdapter {
            ...
            property JsonObject idle: JsonObject {
                property JsonObject general: JsonObject {
                    property string lock_cmd: "slate lock"
                    property string before_sleep_cmd: "loginctl lock-session"
                    property string after_sleep_cmd: "slate screen on"
                }
    ...
    function repairKeybinds() {
        ...
        try {
            ...
            if (current.slate.dashboard && typeof current.slate.dashboard === "object" && !current.slate.dashboard.modifiers) {
                console.log("Migrating nested slate binds to flat structure...");
                const nested = current.slate.dashboard;
                
                // Map old names to new names and update arguments
                if (nested.widgets) {
                    current.slate.launcher = nested.widgets;
                    current.slate.launcher.argument = "slate run launcher";
                }
                if (nested.dashboard) {
                    current.slate.dashboard = nested.dashboard;
                    current.slate.dashboard.argument = "slate run dashboard";
                }
                if (nested.assistant) {
                    current.slate.assistant = nested.assistant;
                    current.slate.assistant.argument = "slate run assistant";
                }
                if (nested.clipboard) {
                    current.slate.clipboard = nested.clipboard;
                    current.slate.clipboard.argument = "slate run clipboard";
                }
                if (nested.emoji) {
                    current.slate.emoji = nested.emoji;
                    current.slate.emoji.argument = "slate run emoji";
                }
                if (nested.notes) {
                    current.slate.notes = nested.notes;
                    current.slate.notes.argument = "slate run notes";
                }
                if (nested.tmux) {
                    current.slate.tmux = nested.tmux;
                    current.slate.tmux.argument = "slate run tmux";
                }
                if (nested.wallpapers) {
                    current.slate.wallpapers = nested.wallpapers;
                    current.slate.wallpapers.argument = "slate run wallpapers";
                }

                // Remove the old nested object
                delete current.slate.dashboard;
                needsUpdate = true;
            }

            if (!current.slate.system) {
                current.slate.system = {};
                needsUpdate = true;
            }

            // Get default binds from adapter
            const adapter = keybindsLoader.adapter;
            if (!adapter || !adapter.slate) return;
            ...
            // Check slate core binds
            const slateKeys = ["launcher", "dashboard", "assistant", "clipboard", "emoji", "notes", "tmux", "wallpapers"];
            for (const key of slateKeys) {
                if (!current.slate[key] && adapter.slate[key]) {
                    console.log("Adding missing slate bind:", key);
                    current.slate[key] = createCleanBind(adapter.slate[key]);
                    needsUpdate = true;
                }
            }
            ...
            for (const key of systemKeys) {
                if (!current.slate.system[key] && adapter.slate.system && adapter.slate.system[key]) {
                    console.log("Adding missing system bind:", key);
                    current.slate.system[key] = createCleanBind(adapter.slate.system[key]);
                    needsUpdate = true;
                }
            }
        ...
        adapter: JsonAdapter {
            property JsonObject slate: JsonObject {
                ...
                property JsonObject dashboard: JsonObject {
                    ...
                    property string dispatcher: "exec"
                    property string argument: "slate run dashboard"
                ...
                property JsonObject assistant: JsonObject {
                    ...
                    property string dispatcher: "exec"
                    property string argument: "slate run assistant"
                }
                property JsonObject clipboard: JsonObject {
                    property list<string> modifiers: ["SUPER"]
                    property string key: "V"
                    property string dispatcher: "exec"
                    property string argument: "slate run clipboard"
                }
                property JsonObject emoji: JsonObject {
                    property list<string> modifiers: ["SUPER"]
                    property string key: "PERIOD"
                    property string dispatcher: "exec"
                    property string argument: "slate run emoji"
                }
                property JsonObject notes: JsonObject {
                    property list<string> modifiers: ["SUPER"]
                    property string key: "N"
                    property string dispatcher: "exec"
                    property string argument: "slate run notes"
                }
                property JsonObject tmux: JsonObject {
                    property list<string> modifiers: ["SUPER"]
                    property string key: "T"
                    property string dispatcher: "exec"
                    property string argument: "slate run tmux"
                }
                property JsonObject wallpapers: JsonObject {
                    property list<string> modifiers: ["SUPER"]
                    property string key: "COMMA"
                    property string dispatcher: "exec"
                    property string argument: "slate run wallpapers"
                }
                property JsonObject system: JsonObject {
                    property JsonObject config: JsonObject {
                        ...
                        property string dispatcher: "exec"
                        property string argument: "slate run config"
                        property string flags: ""
                    }
                    ...
                    property JsonObject overview: JsonObject {
                        ...
                        property string dispatcher: "exec"
                        property string argument: "slate run overview"
                        property string flags: ""
                    }
                    property JsonObject powermenu: JsonObject {
                        ...
                        property string dispatcher: "exec"
                        property string argument: "slate run powermenu"
                        property string flags: ""
                    }
                    property JsonObject tools: JsonObject {
                        ...
                        property string dispatcher: "exec"
                        property string argument: "slate run tools"
                        property string flags: ""
                    }
                    property JsonObject screenshot: JsonObject {
                        ...
                        property string key: "S"
                        property string dispatcher: "exec"
                        property string argument: "slate run screenshot"
                        property string flags: ""
                    }
                    property JsonObject screenrecord: JsonObject {
                        ...
                        property string dispatcher: "exec"
                        property string argument: "slate run screenrecord"
                        property string flags: ""
                    }
                    property JsonObject lens: JsonObject {
                        ...
                        property string key: "A"
                        property string dispatcher: "exec"
                        property string argument: "slate run lens"
                        property string flags: ""
                    }
                    property JsonObject reload: JsonObject {
                        ...
                        property string dispatcher: "exec"
                        property string argument: "slate reload"
                        property string flags: ""
                    }
                    property JsonObject quit: JsonObject {
                        ...
                        property string key: "B"
                        property string dispatcher: "exec"
                        property string argument: "slate quit"
                        property string flags: ""
                    }
                }
            }
            // Default getters
            readonly property var defaultElysiumBinds: {
                "slate": {
                    "launcher": { "modifiers": ["SUPER"], "key": "Super_L", "dispatcher": "exec", "argument": "slate run launcher", "flags": "r" },
                    "dashboard": { "modifiers": ["SUPER"], "key": "D", "dispatcher": "exec", "argument": "slate run dashboard", "flags": "" },
                    "assistant": { "modifiers": ["SUPER"], "key": "A", "dispatcher": "exec", "argument": "slate run assistant", "flags": "" },
                    "clipboard": { "modifiers": ["SUPER"], "key": "V", "dispatcher": "exec", "argument": "slate run clipboard", "flags": "" },
                    "emoji": { "modifiers": ["SUPER"], "key": "PERIOD", "dispatcher": "exec", "argument": "slate run emoji", "flags": "" },
                    "notes": { "modifiers": ["SUPER"], "key": "N", "dispatcher": "exec", "argument": "slate run notes", "flags": "" },
                    "tmux": { "modifiers": ["SUPER"], "key": "T", "dispatcher": "exec", "argument": "slate run tmux", "flags": "" },
                    "wallpapers": { "modifiers": ["SUPER"], "key": "COMMA", "dispatcher": "exec", "argument": "slate run wallpapers", "flags": "" }
                },
                "system": {
                    "config": { "modifiers": ["SUPER", "SHIFT"], "key": "C", "dispatcher": "exec", "argument": "slate run config", "flags": "" },
                    "lockscreen": { "modifiers": ["SUPER"], "key": "L", "dispatcher": "exec", "argument": "loginctl lock-session", "flags": "" },
                    "overview": { "modifiers": ["SUPER"], "key": "TAB", "dispatcher": "exec", "argument": "slate run overview", "flags": "" },
                    "powermenu": { "modifiers": ["SUPER"], "key": "ESCAPE", "dispatcher": "exec", "argument": "slate run powermenu", "flags": "" },
                    "tools": { "modifiers": ["SUPER"], "key": "S", "dispatcher": "exec", "argument": "slate run tools", "flags": "" },
                    "screenshot": { "modifiers": ["SUPER", "SHIFT"], "key": "S", "dispatcher": "exec", "argument": "slate run screenshot", "flags": "" },
                    "screenrecord": { "modifiers": ["SUPER", "SHIFT"], "key": "R", "dispatcher": "exec", "argument": "slate run screenrecord", "flags": "" },
                    "lens": { "modifiers": ["SUPER", "SHIFT"], "key": "A", "dispatcher": "exec", "argument": "slate run lens", "flags": "" },
                    "reload": { "modifiers": ["SUPER", "ALT"], "key": "B", "dispatcher": "exec", "argument": "slate reload", "flags": "" },
                    "quit": { "modifiers": ["SUPER", "CTRL", "ALT"], "key": "B", "dispatcher": "exec", "argument": "slate quit", "flags": "" }
                }
            }

            function getElysiumDefault(section, key) {
                if (defaultElysiumBinds[section] && defaultElysiumBinds[section][key]) {
                    const bind = defaultElysiumBinds[section][key];
                    return {
                        "modifiers": bind.modifiers || [],
                        "key": bind.key || "",
                        "dispatcher": bind.dispatcher || "",
