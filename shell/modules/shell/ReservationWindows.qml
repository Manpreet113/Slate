...
Item {
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "slate:reservation:top"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "slate:reservation:bottom"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "slate:reservation:left"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "slate:reservation:right"
