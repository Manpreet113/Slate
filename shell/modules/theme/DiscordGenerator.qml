...
QtObject {
    ...
    function generate(Colors) {
        ...
        let css = `/**
 * @name Elysium
 * @description A Discord recolor theme, generated with Elysium.
 * @author Axenide
 * @version 1.0.0
 * @invite gHG9WHyNvH
 * @website https://axeni.de/slate
 * @source https://github.com/Axenide/Elysium
...
`
        ...
        const vesktopPath = home + "/.config/vesktop/themes/slate.css"
